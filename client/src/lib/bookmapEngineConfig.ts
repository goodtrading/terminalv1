...
export const HISTORICAL_SURFACE_INITIAL_BACKFILL_MS = 4 * 60 * 1000;
export const HISTORICAL_SURFACE_MAX_GAP_FILL_MS = 12_000;
export const HISTORICAL_SURFACE_RENDER_MIN_INTENSITY = 0.006;
export const HISTORICAL_SURFACE_PRICE_BUCKET_USD = 2.5;
export const HISTORICAL_SURFACE_MIN_CELL_WIDTH_MS = 650;
export const HISTORICAL_SURFACE_PERSISTENT_CELL_WIDTH_MS = 1_200;
