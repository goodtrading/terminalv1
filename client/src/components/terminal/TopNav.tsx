    ...
    <div className="flex h-12 items-center justify-between bg-terminal-bg border-b border-terminal-border px-4 shrink-0 w-full z-10 relative">
      <div className="flex items-center h-full">
        <button
          ...
          className="flex items-center mr-8 cursor-pointer rounded-sm hover:opacity-90 text-left"
        >
          <img
            src="/logo.png"
            alt="GoodTrading logo"
            className="h-6 w-auto object-contain mr-2 opacity-95 pointer-events-none"
          />
          <span className="font-bold text-white tracking-widest text-sm pointer-events-none">
            GOODTRADING{" "}
            <span className="text-terminal-muted font-normal text-xs ml-1">v1.0</span>
          </span>
        </button>
      ...
      <div className="flex items-center space-x-4 text-xs font-mono">
        ...
        <div className="flex items-center space-x-2 border border-terminal-border bg-terminal-panel px-2 py-1 rounded-sm">
          ...
          <span className="text-white" data-testid="text-dominant-expiry">
            {expiryLabel}
          </span>
        </div>
